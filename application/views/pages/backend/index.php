...
<div class="khe-row-padding khe-theme-light" style="padding:20px;">
    ...
    <div style="text-align:right;padding-bottom:5px;">
        <a href="input_form"><p><button class="khe-button khe-teal">เพิ่ม Admin</button></p></a>
    </div>
            ...
            <?php foreach($user as $row){?>
                <tr class="khe-hover-green">
                    ...
                    <td>
                        ...
                        <a href="delete_user?del=<?php echo $row->m_id ?>"onclick="><i class="fa fa-trash-o fa-2x" title="ลบข้อมูล"></i></a>
                        <!-- <a href="#delete" onclick="document.getElementById('delete').style.display='block'"><i class="fa fa-trash-o fa-2x" title="ลบข้อมูล"></i></button></a> -->
                    </td>
                </tr>
            <?php } ?>
    </table>
...
<!-- <div id="delete" class="khe-modal">
    <div class="khe-modal-content" style="width:30%">
        ...
        <div class="khe-container" align="center" style="padding-top:30px;padding-bottom:30px;">
            <a href="delete_user?del=<?php echo $row->m_id; ?>"><button class="khe-btn khe-red khe-border" style="width:30%">ยืนยัน</button></a>
